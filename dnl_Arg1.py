...
# Ejecuta Fuzzy C-Means
centroides, matriz_pertenencia = fuzzy_c_means(df_assembled, n_clusters, difusidad)

# Muestra los resultados
centroides.show(truncate=False)
matriz_pertenencia.show(truncate=False)

# Convierte la matriz_pertenencia a un DataFrame
matriz_pertenencia_df = matriz_pertenencia.select("features", "matriz_pertenencia")

# Une la matriz_pertenencia_df con el DataFrame original df_assembled
df_final = df_assembled.join(matriz_pertenencia_df, "features")
